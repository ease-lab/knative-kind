...
STARTTIME=$(date +%s)
curl -sL https://raw.githubusercontent.com/ease-lab/knative-kind/ease-lab/01-kind.sh | bash
echo -e "🍿 Installing Knative Serving... \033[0m"
curl -sL https://raw.githubusercontent.com/ease-lab/knative-kind/ease-lab/02-serving.sh | bash
echo -e "🔌 Installing Knative Serving Networking Layer ${KNATIVE_NET}... \033[0m"
if [[ "$KNATIVE_NET" == "kourier" ]]; then
    curl -sL https://raw.githubusercontent.com/ease-lab/knative-kind/ease-lab/02-kourier.sh | bash
else
    curl -sL https://raw.githubusercontent.com/ease-lab/knative-kind/ease-lab/02-contour.sh | bash
fi
...
curl -sL https://raw.githubusercontent.com/ease-lab/knative-kind/ease-lab/04-eventing.sh | bash
